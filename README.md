...
In your `config.xml`, you need to add the following preferences:
    ...
    <preference name="SplashHideStatusBar" value="true|False" />
...
"SplashHideNavigationBar" preference is optional. If set to true, the on-screen navigation bar is hidden while the splash screen is displayed.

"SplashHideStatusBar" preference is optional. If set to true, the top status bar is hidden while the splash screen is displayed.
